...
{BLUE}X {ARMAN}PATHANI {WHITE}

\t[×] Developed By Arman Khan{EXTRA} (Khosti)
{WHITE}[•] AUTHOR       : Arman Khosti
{WHITE}[•] STYLE         : Arman🙂
{WHITE}[•] WhatsApp     :   +93783361438
[•] FaceBook     :   Arman Khan
[•] Version      :   0.9
{WHITE}[•] YouTube      :   Khosti Tech

{WHITE}================================================
   \33[37;41m\t Arman  x Khosti  x AFG \33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
def clear():
...
def pak():
                user=[]
                clear()
                print('\033[1;31m CODE EXAMPLE : 0306,0315,93783,93783,93785')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[1;31m EXAMPLE : 2000, 4578, 5790, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
                        limit = 5000
